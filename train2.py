...
import warnings
import os
import psutil # useful for memory management
...
class TrainingAgent():
    ...
    def __init__(self):
        ...
        # Self-play parameters (fixed)
        self.self_play_games_per_generation = 1000
        self.starting_distance = 7
        self.min_distance = 7
        self.win_rate_goal = .50
        self.max_game_length = 100

        # Model training parameters (fixed)
        self.prev_games_to_use_for_data = 10000
        self.data_points_per_training_run = 1020 # randomly chosen from previous games

        # Evaluation parameters (fixed)
        self.games_per_eval_match = 100
        self.win_margin_goal = .55
